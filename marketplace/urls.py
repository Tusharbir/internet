...
urlpatterns = [
    ...
    path('admin-panel/items/', views.AdminItemListView.as_view(), name='admin_items'),
    path('admin-panel/items/<int:pk>/action/', views.AdminItemActionView.as_view(), name='admin_item_action'),
    path('admin-panel/reports/', views.AdminReportListView.as_view(), name='admin_reports'),
    path('admin-panel/reports/<int:pk>/action/', views.AdminReportActionView.as_view(), name='admin_report_action'),
    path('admin-panel/users/', views.AdminUserListView.as_view(), name='admin_users'),
    path('admin-panel/users/<int:pk>/action/', views.AdminUserActionView.as_view(), name='admin_user_action'),
